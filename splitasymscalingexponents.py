...
beta1sym = beta1[betadiff <0.38] #Can change this value depending on the split of the data into symmetric and asymmetric regimes
beta2sym = beta2[betadiff <0.38]

beta1asym = beta1[betadiff>=0.38]
beta2asym = beta2[betadiff>=0.38]
